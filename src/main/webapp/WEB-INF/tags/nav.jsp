        ...
        <nav>
            <ul> 
                ...
                <li><a href="introduce.html">별마로 소개</a>
                    <ul class="sub">
                        <li><a href="introduce.html">별마로 소개</a></li>
                        <li><a href="#a">오시는길</a></li>
                    </ul>
                </li>
                <li><a href="guidance.html">천문대 이용안내</a>
                    <ul class="sub">
                        <li><a href="guidance.html">이용시간/요금안내</a></li>
                        <li><a href="#a">시설소개</a></li>
                        <li><a href="#a">주변관광지</a></li>
                    </ul>
                </li>
                <li><a href="program.html">프로그램</a>
                    <ul class="sub">
                        <li><a href="program.html">일정</a></li>
                        <li><a href="#a">예매하기</a></li>
                        <li><a href="#a">확인/취소</a></li>
                    </ul>
                </li>
                <li><a href="benefit.html">혜택 안내</a>
                    <ul class="sub">
                        <li><a href="benefit.html">이벤트</a></li>
